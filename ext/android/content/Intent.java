...
public class Intent implements Parcelable, Cloneable {
    ...
    public static final String MTK_ACTION_UNREAD_CHANGED = "";
    public static final String MTK_EXTRA_UNREAD_COMPONENT = "";
    public static final String MTK_EXTRA_UNREAD_NUMBER = "";
     ...
     */
    @Deprecated //.BROADCAST_INTENT_ACTION)
    ...
    public static Intent parseIntent(Resources resources, XmlPullParser parser, AttributeSet attrs)
        ...
        TypedArray sa = resources.obtainAttributes(attrs,new int[]{});

        intent.setAction(sa.getString(1));

        String data = sa.getString(1);
        String mimeType = sa.getString(1);
        intent.setDataAndType(data != null ? Uri.parse(data) : null, mimeType);

        String packageName = sa.getString(1);
        String className = sa.getString(1);
