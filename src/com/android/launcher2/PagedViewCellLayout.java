...
public class PagedViewCellLayout extends ViewGroup implements Page {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mOriginalPaddingLeft = mOriginalPaddingLeft;
        mOriginalPaddingRight = mOriginalPaddingRight;
        ...
        if (LauncherLog.DEBUG_LAYOUT) {
            LauncherLog.d(TAG, "onMeasure 1: newWidth = " + newWidth + ", newHeight = " + newHeight
                    + ", widthSpecMode = " + widthSpecMode + ",getPaddingLeft() = " + getPaddingLeft()
                    + ", getPaddingRight() = " + getPaddingRight() + ",mCellCountX = " + mCellCountX
        ...
        if (widthSpecMode == MeasureSpec.AT_MOST) {
            ...
            if (newWidth != widthSpecSize) {
                ...
                mOriginalPaddingLeft += halfGap;
                mOriginalPaddingRight+= (widthSpecSize - newWidth - halfGap);
