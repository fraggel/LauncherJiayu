...
public class Workspace extends SmoothPagedView
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "onTouch: v = " + v + ", event = " + event + ", isFinishedSwitchingState() = "
                    + isFinishedSwitchingState() + ", mState = " + mState + ", getScrollX() = " + getScrollX());
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (LauncherLog.DEBUG_MOTION) {
            LauncherLog.d(TAG, "onInterceptTouchEvent: ev = " + ev + ", getScrollX() = " + getScrollX());
        }
    ...
    protected void snapToPage(int whichPage) {
        ...
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "snapToPage: whichPage = " + whichPage + ", getScrollX() = " + getScrollX());
        }
